var words = [
    {number:1,direction:'down',row:1,column:11,clue:'Harmony exists in ____ - one of the 16 principles of creative intelligence.',answer:'DIVERSITY',hint:' '},
    {number:2,direction:'down',row:1,column:13,clue:'A type of dosha that is characterized by the mobile nature of Wind (Air) energy.',answer:'Vata',hint:' '},
	{number:3,direction:'across',row:2,column:1,clue:'Desire to become the most one can be.',answer:'SelfActualization',hint:' '},
	{number:4,direction:'down',row:7,column:5,clue:'Your basic, underlying nature, your lifelong characteristics.',answer:'Prakriti',hint:' '},
	{number:5,direction:'across',row:8,column:3,clue:'Being freed from the impurities.',answer:'Purification',hint:' '},
	{number:6,direction:'down',row:10,column:13,clue:'It’s a temporary state of balance or imbalance.',answer:'Vikriti',hint:' '},
	{number:7,direction:'down',row:11,column:9,clue:'Action.',answer:'Karma',hint:' '},
	{number:7,direction:'across',row:11,column:9,clue:'Knower --> ___ --> Known.',answer:'KNOWING',hint:' '},
	{number:8,direction:'down',row:12,column:7,clue:'Framework that creates the way we see the world.',answer:'Paradigm',hint:' '},
	{number:9,direction:'across',row:13,column:3,clue:'A type of dosha that embodies the transformative nature of Fire energy.',answer:'Pitta',hint:' '},
    {number:10,direction:'across',row:13,column:12,clue:'Progressive development.',answer:'Growth',hint:' '},
	{number:11,direction:'down',row:13,column:16,clue:'A means to enhance all three factor of mind/brain development.',answer:'TM',hint:' '},
	{number:12,direction:'across',row:14,column:7,clue:'Phase of sleep, when our brain becomes more active.',answer:'REM',hint:' '},
	{number:13,direction:'down',row:15,column:1,clue:'A type of dosha that reflects the binding nature of Earth and Water energy.',answer:'Kapha',hint:' '},
	{number:14,direction:'across',row:15,column:11,clue:'Basic nutrient which is useful to stabilize blood sugar levels.',answer:'FAT',hint:' '},
	{number:15,direction:'across',row:17,column:1,clue:'Field of unity underlying all diversity.',answer:'Perennial',hint:' '},
	{number:16,direction:'across',row:19,column:3,clue:'Right Action.',answer:'Dharma',hint:' '}
  
   ];
//across
// Set global variables
var gridSize = [17,19];     // number of squares wide, number of squares tall
